...
const adminBusinessHourRoutes = require('./routes/api/admin/businessHourRoutes');
const userBusinessHourRoutes = require('./routes/api/user/businessHourRoutes');
...
const availabilityExceptionRoutes = require('./routes/api/admin/availabilityExceptionRoutes');
const businessBreakHourRoutes = require('./routes/api/admin/businessBreakHourRoutes');
...
app.use('/api/admin/business-hours', adminBusinessHourRoutes);
app.use('/api/admin/business-break-hours', businessBreakHourRoutes);
app.use('/api/admin/subscriptions', adminSubscriptionRoutes);
app.use('/api/admin/availability-exceptions', availabilityExceptionRoutes);
...
app.use('/api/user/business-hours', userBusinessHourRoutes);
